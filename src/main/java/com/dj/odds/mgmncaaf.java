...
public class mgmncaaf {
    public static ArrayList<String[]> getOdds() throws Exception {
        ...
        String url = "https://sports.oh.betmgm.com/en/sports/football-11/betting/usa-9/college-football-211";
        ...
        for (Element event : events) {
            Elements participants = event.getElementsByClass("participant ng-star-inserted");
            ...
            if (participants.size() > 0) {
                ...
                String[] odds = {name,
                    ...
                    optionGroups.get(2).select("ms-option").size() > 0 ? optionGroups.get(2).select("ms-option").get(0).text() : ""
                };
                mgmodds.add(odds);
                ...
                if (participants.size() > 1) {
                    ...
                    String[] odds2 = {name,
                        ...
                        optionGroups.get(2).select("ms-option").size() > 0 ? optionGroups.get(2).select("ms-option").get(1).text()  : ""
                    };
